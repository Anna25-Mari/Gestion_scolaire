            ...
            <tr>
                ...
                <td>
                    <div class="actions-cell">
                        <a href="details-eleve.php?id=<?= $eleve['id'] ?>" class="btn btn-primary btn-sm" title="Voir détails">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                        </a>
                        <a href="modifier-eleve.php?id=<?= $eleve['id'] ?>" class="btn btn-warning btn-sm" title="Modifier">
