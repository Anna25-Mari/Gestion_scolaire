                ...
                <div class="form-group">
                    ...
                    <div class="radio-group">
                        <label class="radio-pill">
                            <input type="radio" name="sexe" value="M" <?= ($sexe ?? 'M') === 'M' ? 'checked' : '' ?>>
                            <span>Garçon</span>
                        </label>
                        <label class="radio-pill">
                            <input type="radio" name="sexe" value="F" <?= ($sexe ?? '') === 'F' ? 'checked' : '' ?>>
                            <span>Fille</span>
                        </label>
                    </div>
                </div>
        ...
        <div class="form-section">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="parent_tel" name="parent_tel" placeholder="Ex: 690 00 00 00" value="<?= htmlspecialchars($parent_tel ?? '') ?>">
                </div>
                <div class="form-group full">
                    <label for="adresse">Adresse</label>
                    <input type="text" id="adresse" name="adresse" placeholder="Optionnel" value="<?= htmlspecialchars($adresse ?? '') ?>">
                </div>
            </div>
        </div>
